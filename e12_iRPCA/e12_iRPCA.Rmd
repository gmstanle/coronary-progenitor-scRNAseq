...
No subtypes with small number of genes were detected; instead, cells with low number of genes just look like low-quality cells. Remove cells with < 3500 genes detected to improve clustering. 
...
with(pc.scores[cell.name %in% cells.allr10.rest],points(PC2.score, PC9.score, col = 'green', pch = 20 ))
